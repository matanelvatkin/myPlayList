    ...
    <div>
      <header className="header_home_page">
        ...
        <ul>
          ...
          <li>
            <input type="button" onClick={()=>navigate("./signup")} value="signup" />
          </li>
        </ul>
      </header>
      <main>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus non libero mollitia est! Quas beatae mollitia, nobis minima rerum labore quis nulla, eaque exercitationem nihil iste ipsum sit aut aliquid.
      </main>
    </div>
  )
}
